...
function searchTerapeutas() {
    ...
    terapeutas.forEach(terapeuta => {
        const nombre = terapeuta.querySelector('.inicio-tabla:nth-child(1)').textContent.toLowerCase();
        const rut = terapeuta.querySelector('.centro-tabla:nth-child(2)').textContent.toLowerCase();
        const especialidad = terapeuta.querySelector('.centro-tabla:nth-child(4)').textContent.toLowerCase(); // Nombre de la especialidad
