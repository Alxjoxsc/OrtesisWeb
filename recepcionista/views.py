...
def recepcionista_terapeutas_activos(request):
    ...
    orden = request.GET.get('orden', 'user__first_name')  # Orden por defecto: nombre
    ...
    if query:
        ...
        # Mostrar todos los terapeutas si no hay búsqueda, ordenando por el valor seleccionado
        terapeutas = Terapeuta.objects.all().order_by(orden)
    ...
    return render(request, 'recepcionista_terapeutas_activos.html', context)
